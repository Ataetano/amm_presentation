...
class Melody:
    ...
    def fit(self, original_initial_condition, *args, **kwargs):
    ...
    def variate(self, new_initial_condition, track=None, method="classic", criteria="right", divisions=None, add_note=0):
